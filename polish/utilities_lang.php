...
'backup_utility' => 
'Narzędzia backupowania',

'cache_manager' => 
'Manager pamięci podręcznej',

'communicate' => 
'Porozumiewanie',

'cp_translation' => 
'<abbr title="Control Panel">CP</abbr> Tłumaczenie',
...
'add_member_groups' => 
'Dodaj członka do grup(y)',

'add_member_groups_desc' => 
'Wyślij Email do <b>wszystkich</b> członków wybranej grup(y).',

'attachment' => 
'Załącznik',

'attachment_desc' => 
'Załączniki <b>nie zostały</b> zapisane po wysłaniu.',

'bcc_recipients' => 
'<abbr title="Blind Carbon Copied">BCC</abbr> odbiorcy',

'bcc_recipients_desc' => 
'<abbr title="Blind Carbon Copied">BCC</abbr> Emaile. Proszę oddzielić wielu odbiorców za pomocą przecinka.',
...
'cc_recipients' => 
'<abbr title="Carbon Copied">CC</abbr> odbiorcy',

'cc_recipients_desc' => 
'<abbr title="Carbon Copied">CC</abbr> Emaile. Proszę oddzielić wielu odbiorców za pomocą przecinka.',

'communicate_error' => 
'Uwaga: Niewysłano Emaila',

'communicate_error_desc' => 
'Nie udała się wysyłka tego emaila, prosze przejrzeć i rozwiązać poniższe błędy.',
...
'no_cached_emails' => 
'Nie znaleziono <b>wysłanych emaili</b>.',
